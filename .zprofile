...
# General Settings
# ------------------------------
export EDITOR=vim        # エディタはvimを使う
export LANG=ja_JP.UTF-8  # 文字コード: UTF-8
...
tmp_rprompt='%{${fg[green]}%}[%~]%{${reset_color}%}%b$(git_super_status)'
#tmp_rprompt='%{${fg[green]}%}[%~]%{${reset_color}%}%b$()'
...
alias bes="bundle exec rake db:seed"

alias hint="cat ~/hint.txt"
alias vhint="vim ~/hint.txt"
alias fumi="ssh -fND 1080 fumidai"

# git
alias glhis="git log origin/master..master"
alias glog="git log --pretty=format:\"%ad %H - %an : %s\""
alias gist="git st"
# screen
